...
from pyarchinit_Ipogei_mainapp import pyarchinit_Ipogei
...
class PyArchInitPlugin:
	...
	def initGui(self):
		...
		icon_Ipogei = ('%s%s') % (filepath, os.path.join(os.sep, 'icons','iconIpogei.png'))
		self.actionIpogei = QAction(QIcon(icon_Ipogei), "Scheda ipogeo", self.iface.mainWindow())
		QObject.connect(self.actionIpogei, SIGNAL("triggered()"), self.runIpogei)
		...
		self.menu.addSeparator()
		self.menu.addActions([self.actionIpogei])
		self.menu.addSeparator()
		...
		self.toolBar.addSeparator()
		self.toolBar.addAction(self.actionIpogei)
		self.toolBar.addSeparator()
		...
		self.iface.addPluginToMenu("&pyArchInit - Archaeological GIS Tools", self.actionIpogei)
	...
	def runIpogei(self):
		pluginGui = pyarchinit_Ipogei(self.iface)
		pluginGui.show()
		self.pluginGui = pluginGui # save
	...
	def unload(self):
		...
		self.iface.removePluginMenu("&pyArchInit - Archaeological GIS Tools",self.actionIpogei)
		...
		self.iface.removeToolBarIcon(self.actionIpogei)
